...
new hoverEffect({
   ...
   intensity1:0.6,
   intensity2:.2,
   image1:"https://i.imgur.com/Q0VX5WD.png", //이미지 수정1-1
   image2:"https://i.imgur.com/pFUsAgX.png",
   speedOut:1.6,
   angle:Math.PI/4 * 2,
...
new hoverEffect({
   ...
   intensity1:0.6,
   intensity2:.2,
   image1:"https://i.imgur.com/dGN5QTG.png", //이미지 수정1-2
   image2:"https://i.imgur.com/OCVBcTN.png",
   speedOut:1.6,
   angle:Math.PI/4 * 2,
...
new hoverEffect({
   ...
   intensity1:0.6,
   intensity2:.2,
   image1:"https://i.imgur.com/xVVtJNE.png", //이미지 수정1-3
   image2:"https://i.imgur.com/Qt2hqq8.png",
   speedOut:1.6,
   angle:Math.PI/4 * 2,
...
new hoverEffect({
   ...
   intensity1:0.6,
   intensity2:.2,
   image1:"https://i.imgur.com/LvZzUSN.png", //이미지 수정1-4
   image2:"https://i.imgur.com/gjFJXIF.png",
   speedOut:1.6,
   angle:Math.PI/4,
   displacementImage:"https://i.imgur.com/pJ43oAP.jpg"
});
...
setTimeout(function(){
    ...
    my_header.innerHTML = "입력하려면 터치...";
},16000);

setTimeout(function(){
    var my_header = document.getElementsByClassName("my_header")[0];
    my_header.innerHTML = "데이터 초기화 중...";
},2000);

setTimeout(function(){
    var my_header = document.getElementsByClassName("my_header")[0];
    my_header.innerHTML = "이미지 다운로드 중...";
},5000);

setTimeout(function(){
    var my_header = document.getElementsByClassName("my_header")[0];
    my_header.innerHTML = "애니메이션 제작 중...";
},10000);
